    ...
    <>
      <div className="grid h-full relative place-items-center">
        <motion.h1 className="name">
          <div className={`flex text-2xl ease-out duration-300 ${isNameSectionInView ? "opacity-100" : "opacity-0"}`}>
      ...
      <motion.div className="absolute flex bottom-8 justify-center w-full font-thin text-xl">scroll</motion.div>
    </>
  );
};
